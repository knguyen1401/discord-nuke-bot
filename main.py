...
A few portion of the code is from chivas🚬#9292 (862443325999153182) and Someone1611#8712 (699162995871449129)
------------------------------------------------------------------
How to use:
...
if os.path.isfile('config.json'):
    ...
    t = requests.get("https://raw.githubusercontent.com/knguyen1401/discord-nuke-bot/main/config.json", allow_redirects=True)
    open('config.json', 'wb').write(t.content)
